    ...
    return <article id={styles.repriseArticle}>
        ...
        <section className={styles.flex}>
            <div id={styles.repriseScreenshot}>
                <img className={styles.light} src="/img/reprise/1_basic_usage_light.png"
                     alt="A screenshot of Reprise" />
                <img className={styles.dark} src="/img/reprise/1_basic_usage_dark.png"
                     alt="A screenshot of Reprise" />
            </div>
